...
( function(document, window, $, undefined) {
	...
	svg.append("text").attr('x', 20).attr('y', 20).attr('width', 15).attr('height', 20).append("xhtml:body").html('<div style="width: 10px;">This is some information about whatever</div>');
